...
const OrderConfirmed = () => {
    ...
    return (
        <div className="bg-white w-160 p-16 flex flex-col jusify-center items-center mx-auto">
            <Image src="/images/icon-order-confirmed.svg" alt="order submitted" width={117} height={117} className="mb-4"/>
